...
from app.core.types import Author, AuthorKind, DocType, Entry, Violation, Warning
...
def test_item_blocks_matches_validate_py_on_all_specs(db_session: Session) -> None:
    ...
    spec = importlib.util.spec_from_file_location("v", os.path.join(_ROOT, "tools/validate.py"))
...
def test_save_deleted_pks_and_warnings(db_session: Session) -> None:
    ...
    from app.core.types import ValidateResult, Violation
    from app.core.types import Warning as W
