...
<div class="adminbody">
  <table class="vers" data-el="2">
    <tr><th>프로젝트</th><th>저장소</th><th>마지막 처리 커밋</th><th>동기화</th><th>마지막 백업</th><th></th></tr>
    <tr data-el="2.1"><td><b>SYNC</b></td><td class="lbl">dfocus/syncdoc</td><td><span class="mono" data-el="2.2">a1b2c3d</span> <span class="lbl">1시간 전</span></td><td data-el="2.3"><span class="st ok">최신</span></td><td data-el="2.4"><span class="lbl">7시간 전</span></td><td><span class="btn sm" data-el="3">인덱스 재구축</span> <span class="btn sm" data-el="6">백업에서 복원</span></td></tr>
    <tr><td><b>DBA</b></td><td class="lbl">dfocus/dba-ax</td><td><span class="mono">9e8f7a6</span> <span class="lbl">3일 전</span></td><td><span class="st rv">밀림 2</span></td><td><span class="warn">5일 전</span></td><td><span class="btn sm">인덱스 재구축</span> <span class="btn sm">백업에서 복원</span></td></tr>
    <tr><td><b>AIRD</b></td><td class="lbl">dfocus/airdata</td><td><span class="mono">—</span></td><td><span class="st na">문서 없음</span></td><td><span class="lbl">없음</span></td><td><span class="btn sm">인덱스 재구축</span> <span class="btn sm">백업에서 복원</span></td></tr>
  </table>
...
| 2.4 | 마지막 백업 | 텍스트 | `backup/tracking.json`의 마지막 커밋 시각. 한 번도 없으면 `없음`. **주기의 두 배가 넘게 지났으면 경고색** — 백업이 조용히 멈춘 것을 여기서 알아챈다(인프라 6.1) | — |
...
| 6 | 백업에서 복원 | 버튼 | 행마다. `backup/tracking.json`이 없으면 비활성 | 확인 다이얼로그(4와 같은 모양) → 실행. 끝나면 결과(5)에 들어온 수와 건너뛴 수 |
